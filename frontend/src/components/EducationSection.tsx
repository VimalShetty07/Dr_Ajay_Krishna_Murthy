  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="bg-gradient-to-br from-amber-50 to-amber-50 rounded-3xl shadow-xl p-12 border border-amber-100">
          {/* Header */}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-amber-200">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-amber-600 font-semibold">MS Ophthalmology</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-amber-200">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-amber-600 font-semibold">Advanced Specialized Training</p>
                </div>
              </div>
              <div className="space-y-3">
