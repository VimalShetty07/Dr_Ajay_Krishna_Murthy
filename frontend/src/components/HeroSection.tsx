        ...
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="lg:col-span-2 text-center">
            <div className="relative inline-block">
              ...
              <div className="relative w-100 h-140 mx-auto rounded-xl overflow-hidden shadow-2xl border-4 border-white/90">
                ...
                <button
                  onClick={prevSlide}
                  className="absolute left-3 top-1/2 transform -translate-y-1/2 w-8 h-8 bg-white/90 hover:bg-white rounded-md shadow-lg flex items-center justify-center transition-all duration-200 z-20"
                >
                ...
                <button
                  onClick={nextSlide}
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 w-8 h-8 bg-white/90 hover:bg-white rounded-md shadow-lg flex items-center justify-center transition-all duration-200 z-20"
                >
                  <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-3">
            <div className="space-y-8">
              ...
              {/* CTA Button */}
              <div className="pt-4">
                <button className="bg-amber-700 hover:bg-amber-800 text-white font-medium py-4 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                  Book Consultation
                </button>
              </div>
            </div>
